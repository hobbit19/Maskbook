...
import _mainnet from '../../../mainnet_erc20.json'
import _rinkeby from '../../../rinkeby_erc20.json'
const mainnet: ERC20TokenPredefinedData = [..._mainnet].sort(sort)
const rinkeby: ERC20TokenPredefinedData = [..._rinkeby].sort(sort)
